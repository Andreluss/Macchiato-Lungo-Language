 ...
 */
public class Declaration extends InstructionBase {
     ...
     */
    public Declaration(char variable, Expression expression) {
    ...
    public void run(MacchiatoEnvironment environment) throws MacchiatoException {
        ...
        environment.pauseExecutionIfNeeded(Declaration.this);
